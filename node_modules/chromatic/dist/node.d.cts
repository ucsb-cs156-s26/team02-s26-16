...
interface Context {
  ...
  git: {
    version?: string; /** The absolute location on disk of the git project */
    rootPath?: string; /** The current user's email as pre git config */
    gitUserEmail?: string;
    branch: string;
    commit: string;
...
//#endregion
export { type Configuration, type Context, type Flags, GitInfo, InitialContext, type Logger, type Options, type TaskName, createLogger, getConfiguration, getGitInfo, run, runAll };
